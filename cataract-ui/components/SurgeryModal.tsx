        ...
        <div className="flex-1 flex flex-col bg-slate-50 min-h-0 overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-8 pb-4">
                ...
                <div className="bg-white rounded-[24px] p-6 border border-slate-100 shadow-sm flex items-center gap-5">
                    ...
                    <div>
                        <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-0.5">ARRIVAL TIME</div>
                ...
                <div className="bg-white rounded-[24px] p-6 border border-slate-100 shadow-sm flex items-center gap-5">
                    ...
                    <div>
                        <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-0.5">LOCATION</div>
                        <div className="text-xl font-black text-slate-900 leading-tight tracking-tight">Eye Surgery Center</div>
                        <div className="text-sm font-medium text-slate-500">Suite 200 • Main Entrance</div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="relative space-y-12 py-2">
                            ...
                            <div className="relative pl-14">
                                ...
                                <h3 className="text-base font-black text-slate-900 leading-tight mb-1">Check-in & Prep</h3>
                                <p className="text-sm font-medium text-slate-500">Wait time approx 30m</p>
                            </div>
                            ...
                            <div className="relative pl-14">
                                ...
                                <h3 className="text-base font-black text-slate-700 leading-tight mb-1">Dilation</h3>
                                <p className="text-sm font-medium text-slate-400">Drops administered to widen pupil</p>
                            </div>
                            ...
                            <div className="relative pl-14 opacity-60">
                                ...
                                <h3 className="text-base font-black text-slate-700 leading-tight mb-1">Procedure</h3>
                                <p className="text-sm font-medium text-slate-400">Approx 15-20 mins</p>
                            </div>
                            ...
                            <div className="relative pl-14 opacity-60">
                                ...
                                <h3 className="text-base font-black text-slate-700 leading-tight mb-1">Recovery</h3>
                                <p className="text-sm font-medium text-slate-400">Rest & snack provided</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="bg-white rounded-[24px] p-5 border border-slate-100 shadow-sm space-y-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-slate-900 text-sm">Blurry Vision</h4>
                                    <p className="text-[12px] font-medium text-slate-500">Improving by tomorrow</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-[24px] p-5 border border-slate-100 shadow-sm space-y-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-slate-900 text-sm">Large Pupils</h4>
                                    <p className="text-[12px] font-medium text-slate-500">Lasts about 24 hours</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-[24px] p-5 border border-slate-100 shadow-sm space-y-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-slate-900 text-sm">Scratchy Feeling</h4>
                                    <p className="text-[12px] font-medium text-slate-500">Like an eyelash is stuck</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-[24px] p-5 border border-slate-100 shadow-sm space-y-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-slate-900 text-sm">The Patch</h4>
                                    <p className="text-[12px] font-medium text-slate-500">Keep on until follow-up</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-violet-50 p-4 rounded-3xl border border-violet-100 flex items-center gap-4">
                            ...
                            <p className="text-[13px] font-bold text-slate-700 leading-tight">
                                ...
                                <span className="text-slate-500 font-medium">Call the surgery center helpline at</span> <span className="text-violet-700 font-black">555-0123</span>
                            </p>
                        </div>
                    </div>
                </div>
...
const SurgeryModal: React.FC<SurgeryModalProps> = ({ patient, onClose, isDayOfSurgery = false, moduleContent, onOpenChat }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 animate-[fadeIn_0.2s_ease-out]">
            ...
            {/* Modal Container */}
            <div className="relative w-full max-w-5xl h-[92vh] bg-white rounded-[32px] shadow-2xl overflow-hidden flex flex-col animate-[scaleIn_0.2s_ease-out]">
                {/* Header */}
                <div className="flex items-center justify-between px-8 py-5 border-b border-slate-100/50 bg-white shrink-0">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[12px] font-bold text-slate-400 uppercase tracking-widest leading-none">
                                {isDayOfSurgery ? 'Live Patient Guide' : 'Understanding your procedure options'}
                            </p>
                        </div>
                    </div>
                    <button
                ...
                {isDayOfSurgery ? (
                    ...
                    <div className="flex-1 overflow-y-auto p-8 space-y-12 bg-slate-50" style={{ scrollbarGutter: 'stable' }}>
                        ...
                        <div className="relative flex items-center justify-center">
                            ...
                            <span className="relative z-10 bg-slate-50 px-6 text-sm font-bold text-slate-400 uppercase tracking-widest">
                                    ...
                                    <div className="space-y-8">
                                        <div>
                                            ...
                                            <p className="text-slate-600 leading-relaxed text-base">
                                                ...
                                                An ultrasound device is then used to break up and remove the cataract.
                                            </p>
                                        </div>

                                        <div>
                                            <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">Key Features</h3>
                                            <ul className="space-y-4">
                                                <li className="flex items-start gap-4">
                                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                                                        <Check size={14} className="text-emerald-600" strokeWidth={3} />
                                                    </div>
                                                    <span className="text-slate-700 font-medium">Performed manually by your surgeon</span>
                                                </li>
                                                <li className="flex items-start gap-4">
                                                    <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                                                        <Check size={14} className="text-emerald-600" strokeWidth={3} />
                                                    </div>
                                                    <span className="text-slate-700 font-medium">Standard recovery timeline</span>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="inline-flex items-center gap-3 px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-sm font-bold text-slate-900">Fully Covered</div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <section className={`rounded-3xl p-1 shadow-xl border-2 ${isEligibleForLaser ? 'bg-violet-50/30 border-violet-100 shadow-violet-100/50' : 'bg-white border-slate-100'}`}>
                            <div className="p-8 md:p-10">
                                ...
                                <div className="mb-8">
                                    {isEligibleForLaser ? (
                                        <div className="bg-green-50 border border-green-100 rounded-xl p-4 flex items-start gap-4 mb-8">
                                            <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                                                <Check size={16} className="text-green-600" strokeWidth={3} />
                                            </div>
                                            <div>
                                                <h4 className="font-bold text-green-800 text-sm mb-1">You are eligible for Laser-Assisted Surgery</h4>
                                                <p className="text-green-700 text-sm">Based on your corneal thickness and cataract density.</p>
                                            </div>
                                        </div>
                                    ) : (
                                        <div className="bg-rose-50 border border-rose-100 rounded-xl p-4 flex items-start gap-4 mb-8">
                                            <div className="w-8 h-8 rounded-full bg-rose-100 flex items-center justify-center flex-shrink-0">
                                                <Info size={16} className="text-rose-600" strokeWidth={3} />
                                            </div>
                                            <div>
                                                <h4 className="font-bold text-rose-800 text-sm mb-1">Not Recommended</h4>
                                    ...
                                    <div className="flex items-center gap-4 mb-2">
                                        <h2 className="text-2xl font-bold text-slate-900">Laser-Assisted Surgery</h2>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                                    <div className="space-y-8">
                                        ...
                                        <div>
                                            <h3 className="text-xs font-bold text-violet-700 uppercase tracking-wider mb-4 flex items-center gap-2">
                                            ...
                                            <ul className="space-y-4">
                                                <li className="flex items-start gap-4">
                                                    ...
                                                    <span className="text-slate-700 font-medium">Enhanced precision for astigmatism correction</span>
                                                </li>
                                                <li className="flex items-start gap-4">
                                                    <div className="w-6 h-6 rounded-full bg-violet-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                                                        <Check size={14} className="text-violet-600" strokeWidth={3} />
                                                    </div>
                                                    <span className="text-slate-700 font-medium">Potentially faster recovery time</span>
                                                </li>
                                                <li className="flex items-start gap-4">
                                                    <div className="w-6 h-6 rounded-full bg-violet-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                                                        <Check size={14} className="text-violet-600" strokeWidth={3} />
                                                    </div>
                                                    <span className="text-slate-700 font-medium">Less ultrasound energy used on the eye</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
